...
;; packages are loaded before you start tryingto modify them.
...
(global-set-key (kbd "C-x C-g") 'kibit-current-file)
...
(add-to-list 'load-path "/home/me/.apps/neotree")
  (require 'neotree)
